...
import { User, Role, MCPConnector, Message, ThoughtStep, Citation } from './style/types';
  ...
  sendMessage: async (text, attachment, options) => {
    ...
    try {
      ...
      await ApiService.sendMessageStream(
        ...
        { clientName: selectedClient || undefined, agentMode: get().agentMode }, // Pass selectedClient and agentMode
        {
